      ...
      <form @submit.prevent="handleSubmit">
        <div class="modal-body text-bg-light" >
            <div class="form-group">
              ...
              <span v-for="error in v$.username.$errors" :key="error.$uid" class="text-danger fw-bold">{{ error.$message }}</span>
            ...
            <div class="form-group">
              ...
              <span v-for="error in v$.email.$errors" :key="error.$uid" class="text-danger fw-bold">{{ error.$message }}</span>
            </div>
            <div class="form-group">
              <label for="password" class="col-form-label">{{$t('register.password')}} :</label>
              <input type="password" class="form-control" id="password" v-model="registerForm.password"></input>
              <span v-for="error in v$.password.$errors" :key="error.$uid" class="text-danger fw-bold">{{ error.$message }}</span>
            </div>
        </div>
